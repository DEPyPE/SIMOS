...
INSERT INTO Tema(ID_ProgramaProyecto, TituloDelTema, ContenidoDelTema, Observacion, ConObservacion, IconoEstado, Estado)
	   VALUES(1, 'Contribución y destino',
				 ...
				 '', true, 'assignment', 'Con observación');
...
INSERT INTO Tema(ID_ProgramaProyecto, TituloDelTema, ContenidoDelTema, Observacion, ConObservacion, IconoEstado, Estado)
	   VALUES(1, 'Procedimientos documentados de planeación de los recursos para la prestación de los servicios de educación tecnológica y de adultos',
				 ...
				 '', false, 'assignment_turned_in', 'Observación validada');
...
UPDATE Tema SET Tema.Observacion = '', Tema.ConObservacion = false, Tema.Estado = 'Observación validada', Tema.IconoEstado = 'assignment_turned_in' WHERE Tema.ID_Tema = 4;
